...
# Baseline Before / After for 运维工程师
...
- First-use demo: prepare a production deploy runbook with preflight, canary, rollback, incident channel, and post-checks.
- Expected outputs: preflight checklist, canary plan, rollback command set, incident timeline.
- Main risks controlled: alert fatigue, manual drift, slow rollback, missing owner handoff.
