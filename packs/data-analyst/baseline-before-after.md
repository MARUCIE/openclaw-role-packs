...
# Baseline Before / After for 数据分析师
...
- First-use demo: diagnose a revenue dashboard drop with metric contract, cohort split, anomaly checks, and action readout.
- Expected outputs: metric contract, cohort analysis, anomaly worksheet, decision readout.
- Main risks controlled: metric ambiguity, dashboard theater, aggregation bias, actionless reporting.
