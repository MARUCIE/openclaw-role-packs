...
- lineage map: owner, input, output, validation.
- freshness SLA: owner, input, output, validation.
- backfill runbook: owner, input, output, validation.
- cost guardrail: owner, input, output, validation.
...
| --- | --- | --- | --- | --- |
| silent schema drift | Before rollout | high | quality gate | reduce scope |
