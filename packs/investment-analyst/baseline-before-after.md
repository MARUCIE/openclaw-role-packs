...
# Baseline Before / After for 投资分析师
...
- First-use demo: build an investment memo for an AI tooling company with thesis, scenarios, risks, and diligence plan.
- Expected outputs: investment memo, scenario model, risk matrix, diligence checklist.
- Main risks controlled: single-scenario optimism, weak comparables, ignored liquidity risk, unclear catalyst.
