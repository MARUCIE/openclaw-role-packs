...
# Advisor Routing for 投资分析师 (investment-analyst)
...
- Use for failure modes, operational risk, compliance exposure, and rollout
  readiness.
- Checks role-specific risk: single-scenario optimism; weak comparables; ignored liquidity risk; unclear catalyst.
