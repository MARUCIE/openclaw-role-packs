...
# Baseline Before / After for 算法工程师
...
- First-use demo: triage invoice OCR model regression with offline metric, ablation table, drift hypothesis, and rollout gate.
- Expected outputs: experiment contract, metric ladder, ablation table, inference rollout gate.
- Main risks controlled: metric gaming, data leakage, offline-online mismatch, unbounded inference cost.
