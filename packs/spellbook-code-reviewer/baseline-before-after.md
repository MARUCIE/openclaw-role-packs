...
# Baseline Before / After for 代码审查师
...
- First-use demo: review a pull request for contract breakage, missing tests, dependency risk, and release blockers.
- Expected outputs: ranked findings, test gap map, contract risk note, merge gate.
- Main risks controlled: style-only review, missing edge cases, unverified assumptions, dependency drift.
