...
# Document Templates for 基础架构工程师
...
- topology map: owner, input, output, validation.
- release gate: owner, input, output, validation.
- rollback drill: owner, input, output, validation.
- observability checklist: owner, input, output, validation.
...
| --- | --- | --- | --- | --- |
| configuration drift | Before rollout | high | quality gate | reduce scope |
