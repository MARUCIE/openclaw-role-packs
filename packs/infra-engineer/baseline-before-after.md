...
# Baseline Before / After for 基础架构工程师
...
- First-use demo: review a Cloudflare Pages plus Worker release for topology risk, rollback, observability, and IaC drift.
- Expected outputs: topology map, release gate, rollback drill, observability checklist.
- Main risks controlled: configuration drift, missing rollback path, secret exposure, single-region fragility.
