...
# Baseline Before / After for 内控专家
...
- First-use demo: design controls for invoice approval automation with SoD, evidence capture, exception queue, and audit trail.
- Expected outputs: control matrix, evidence trail, exception workflow, audit readiness pack.
- Main risks controlled: control bypass, missing evidence, unclear ownership, manual override abuse.
