...
# Advisor Routing for AB 测试分析师 (ab-test-analyst)
...
- Use for failure modes, operational risk, compliance exposure, and rollout
  readiness.
- Checks role-specific risk: peeking bias; underpowered test; metric collision; survivorship bias.
