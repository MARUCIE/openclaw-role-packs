...
# Baseline Before / After for AB 测试分析师
...
- First-use demo: design an experiment for checkout copy with MDE, sample size, guardrail metrics, and decision rules.
- Expected outputs: experiment spec, power table, guardrail metrics, decision readout.
- Main risks controlled: peeking bias, underpowered test, metric collision, survivorship bias.
