...
# Baseline Before / After for 入职引导
...
- First-use demo: create a first-week onboarding path for a new AI coding operator with setup checks and first delivery.
- Expected outputs: onboarding map, first-task script, readiness checklist, handoff template.
- Main risks controlled: unclear first task, tooling mismatch, missing access, unowned follow-up.
