...
- strategy options: owner, input, output, validation.
- assumption ledger: owner, input, output, validation.
- resource tradeoff: owner, input, output, validation.
- decision cadence: owner, input, output, validation.
...
| --- | --- | --- | --- | --- |
| narrative bias | Before rollout | high | quality gate | reduce scope |
